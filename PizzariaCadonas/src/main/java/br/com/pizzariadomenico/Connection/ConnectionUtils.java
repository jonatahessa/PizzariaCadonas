...
public class ConnectionUtils {
    ...
    public static java.sql.Connection getConnection() {
        ...
        try {
            ...
            String serveName = "cadonas01.mysql.uhserver.com"; // Caminho do servidor do BD
            String mydatabase = "cadonas01"; // Nome do banco de dados
            String url = "jdbc:mysql://" + serveName + "/" + mydatabase;
            String username = "cadonas01"; // Nome de usuario
